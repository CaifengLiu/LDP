This repo is based on [VAC (ICCV 2021)](https://openaccess.thecvf.com/content/ICCV2021/html/Min_Visual_Alignment_Constraint_for_Continuous_Sign_Language_Recognition_ICCV_2021_paper.html). 
...
We provide the checkpoint on the PHOENIX2014 dataset as an example.
### PHOENIX2014 dataset

| Backbone | Dev WER  | Test WER  | Pretrained model                                             |
| -------- | ---------- | ----------- | --- |
| ResNet18 | 19.0%      | 19.6%       | [[Baidu]](链接: https://pan.baidu.com/s/17U6rQbbOAfN7SuJGAlw2Ag?pwd=hhm3) (passwd: hhm3) |
